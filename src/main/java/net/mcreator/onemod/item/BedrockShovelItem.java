...
public class BedrockShovelItem extends OnemodModElements.ModElement {
	@ObjectHolder("onemod:bedrock_shovel")
	public static final Item block = null;
	public BedrockShovelItem(OnemodModElements instance) {
		super(instance, 10);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ShovelItem(new IItemTier() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Blocks.BEDROCK), new ItemStack(Blocks.DIAMOND_BLOCK));
			}
